    ...
    <>
      ...
      >
        ...
        <div className="h-16 px-4 flex items-center justify-between border-b border-slate-100 relative z-10">
          ...
          >
            {settings.churchLogo ? (
              <img src={getImageUrl(settings.churchLogo)} alt="Logo" className="w-10 h-10 rounded-full object-contain flex-shrink-0 group-hover:scale-105 transition-transform" />
            ) : (
              <div className="w-10 h-10 rounded-full bg-indigo-600 flex-shrink-0 flex items-center justify-center font-black text-white text-lg shadow-md shadow-indigo-600/30">
