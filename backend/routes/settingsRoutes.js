...
const { getSettings, updateSettings, resetData, addAnbiyam, testSMS } = require('../controllers/settingsController');
...
router.post('/test-sms', authMiddleware, checkRole(['Admin', 'Treasurer']), testSMS);
